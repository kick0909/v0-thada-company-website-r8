...
const translations = {
  th: {
    ...
    signOut: "ออกจากระบบ",
    // Email Verification
    verifyEmailTitle: "ตรวจสอบอีเมลของคุณ",
    verifyEmailDescription: "เราได้ส่งลิงก์ยืนยันไปยังอีเมลของคุณแล้ว",
    checkInboxTitle: "ตรวจสอบกล่องจดหมาย",
    checkInboxDesc: "มองหาอีเมลจาก THADA พร้อมลิงก์ยืนยันของคุณ",
    clickConfirmTitle: "คลิกลิงก์ยืนยัน",
    clickConfirmDesc: "การดำเนินการนี้จะยืนยันอีเมลและเปิดใช้งานบัญชีของคุณ",
    startRentingTitle: "เริ่มเช่า",
    startRentingDesc: "เมื่อยืนยันแล้ว ให้เข้าสู่ระบบเพื่อเรียกดูและเช่าอุปกรณ์",
    goToSignIn: "ไปที่หน้าเข้าสู่ระบบ",
    didntReceiveEmail: "ไม่ได้รับอีเมล?",
    resendConfirmation: "ส่งการยืนยันอีกครั้ง",
    checkSpamFolder: "ตรวจสอบโฟลเดอร์สแปม",
    checkSpamFolderDesc: "บางครั้งอีเมลยืนยันอาจอยู่ในโฟลเดอร์สแปมหรือขยะ",
    waitFewMinutes: "รอสักครู่",
    waitFewMinutesDesc: "อีเมลอาจใช้เวลาสักครู่ในการมาถึง",
  },
  en: {
    home: "Home",
    ...
    verifyEmailDescription: "We've sent you a confirmation link to verify your account",
    checkInboxTitle: "Check your inbox",
    checkInboxDesc: "Look for an email from THADA with your confirmation link",
    clickConfirmTitle: "Click the confirmation link",
    clickConfirmDesc: "This verifies your email and activates your account",
    startRentingTitle: "Start renting",
    startRentingDesc: "Once confirmed, sign in to browse and rent equipment",
    goToSignIn: "Go to sign in",
    didntReceiveEmail: "Didn't receive the email?",
    resendConfirmation: "Resend confirmation",
    checkSpamFolder: "Check spam folder",
    checkSpamFolderDesc: "Sometimes confirmation emails end up in spam or junk folders",
    waitFewMinutes: "Wait a few minutes",
    waitFewMinutesDesc: "Emails may take a moment to arrive",
  },
}

...
const products = [
  ...
  {
    id: 11,
    name: "Canon NPG-67 Toner",
    brand: "Canon",
    type: "ตลับหมึก",
    image: "/canon-toner-cartridge-black.jpg",
    features: ["ตลับหมึกสีดำ", "ความจุสูง 21,000 หน้า", "คุณภาพพิมพ์คมชัด"],
    isNew: false,
    isHot: true,
  },
  {
    id: 12,
    name: "Canon GPR-53 Color Toner Set",
    brand: "Canon",
    type: "ตลับหมึก",
    image: "/canon-color-toner-cartridge-set.jpg",
    features: ["ชุดตลับหมึกสี 4 สี (CMYK)", "ความจุ 19,000 หน้า/สี", "สีสันสดใส"],
    isNew: true,
    isHot: false,
  },
  {
    id: 13,
    name: "Xerox 006R01513 Toner",
    brand: "Xerox",
    type: "ตลับหมึก",
    image: "/xerox-toner-cartridge.jpg",
    features: ["ตลับหมึกสีดำ", "ความจุ 26,000 หน้า", "ليكジี EA-Eco"],
    isNew: false,
    isHot: true,
  },
  {
    id: 14,
    name: "Ricoh MP C2503 Toner Set",
    brand: "Ricoh",
    type: "ตลับหมึก",
    image: "/ricoh-color-toner-set.jpg",
    features: ["ชุดตลับหมึกสี 4 สี", "ความจุ 18,000 หน้า/สี", "คุณภาพสูง"],
    isNew: true,
    isHot: true,
  },
  {
    id: 15,
    name: "Ricoh Type MP 2501 Black Toner",
    brand: "Ricoh",
    type: "ตลับหมึก",
    image: "/ricoh-black-toner-cartridge.jpg",
    features: ["ตลับหมึกสีดำ", "ความจุ 9,000 หน้า", "ราคาประหยัด"],
    isNew: false,
    isHot: false,
  },
]
